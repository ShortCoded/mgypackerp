...
foreach ([
    ...
    'hr.social_insurance_policies' => ['سياسات التأمينات الاجتماعية', 'سياسة تأمينات اجتماعية'],
    'hr.employment_tax_policies' => ['سياسات ضريبة المرتبات', 'سياسة ضريبة مرتبات'],
] as $prefix => [$plural, $singular]) {
...
$hrAttendanceAndRequestPermissionLabels = [
    'hr.attendance_settings.view' => 'عرض إعدادات الحضور والانصراف',
    'hr.attendance_settings.manage' => 'إدارة إعدادات الحضور والانصراف',
    'hr.shift_assignments.view' => 'عرض تخصيص الورديات',
    'hr.shift_assignments.manage' => 'إدارة تخصيص الورديات',
    ...
    'hr.payroll_payment_reports.view' => 'عرض تقرير مدفوعات الرواتب',
    'hr.payroll_payment_reports.export' => 'تصدير تقرير مدفوعات الرواتب',
    ...
    'hr.leave_types.create' => 'إنشاء أنواع الإجازات',
    'hr.leave_types.update' => 'تعديل أنواع الإجازات',
    'hr.leave_types.delete' => 'حذف أنواع الإجازات',
    'hr.leave_types.view_deleted' => 'عرض أنواع الإجازات المحذوفة',
    'hr.leave_types.restore' => 'استعادة أنواع الإجازات',
    'hr.payroll_attendance_policies.view' => 'عرض إعدادات الرواتب والحضور',
    'hr.payroll_attendance_policies.manage' => 'إدارة إعدادات الرواتب والحضور',
    'hr.employee_reports.view' => 'عرض تقرير الموظفين',
    'hr.employee_reports.export' => 'تصدير تقرير الموظفين',
    'hr.leave_reports.view' => 'عرض تقرير طلبات الموظفين والإجازات',
    'hr.leave_reports.export' => 'تصدير تقرير طلبات الموظفين والإجازات',
];
...
return [
    ...
    'dashboard.summaries.sales.view' => 'عرض ملخص المبيعات بلوحة التحكم',
    'dashboard.summaries.purchases.view' => 'عرض ملخص المشتريات بلوحة التحكم',
    'price_lists.review' => 'مراجعة قوائم الأسعار',
    'price_lists.approve' => 'اعتماد قوائم الأسعار',
    ...
    'chat.reports.view' => 'عرض تقرير المحادثات',
    'chat.reports.export' => 'تصدير تقرير المحادثات إلى Excel',
    'chat.reports.pdf' => 'تصدير تقرير المحادثات إلى PDF',
    'chat.reports.print' => 'طباعة تقرير المحادثات',
    ...
    'maintenance.plans.readings' => 'تسجيل قراءات خطط الصيانة',
    'fixed_assets.accounting.configure' => 'تهيئة حسابات الأصول الثابتة',
    'fixed_assets.improvement.post' => 'ترحيل تحسين الأصل',
    'fixed_assets.improvement.reverse' => 'عكس تحسين الأصل',
    'fixed_assets.recognition.reverse' => 'عكس إثبات الأصل',
    'fixed_assets.custody.post' => 'ترحيل عهدة الأصل',
    'fixed_assets.disposal.reverse' => 'عكس استبعاد الأصل',
    'fixed_assets.reports' => 'عرض تقارير الأصول الثابتة',
    'file_manager.folders.restore' => 'استعادة مجلدات الملفات',
