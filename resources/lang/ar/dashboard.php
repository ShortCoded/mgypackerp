...
return [
    ...
    'plastics' => [
        ...
        'sections' => [
            ...
            'operational_exceptions' => 'الاستثناءات التشغيلية القابلة للتنفيذ',
        ...
        'metrics' => [
            ...
            'low_stock' => ['title' => 'مخزون منخفض', 'meta' => 'أرصدة صنف/مخزن أقل من حد إعادة الطلب المضبوط'],
            'material_shortages' => ['title' => 'عجز الخامات', 'meta' => 'بنود طلبات خامات الإنتاج التي ما زال بها عجز'],
            'production_remaining' => ['title' => 'المتبقي من الإنتاج', 'meta' => 'أوامر إنتاج نشطة ما زالت بها كمية لم تُستلم'],
            'quality_pending' => ['title' => 'فحوص جودة معلقة', 'meta' => 'فحوص ما زالت داخل دورة عمل الجودة'],
            'quality_rejected' => ['title' => 'مرفوضات الجودة', 'meta' => 'الفحوص المرفوضة أو ذات النتيجة غير المطابقة'],
            'pending_sales_actions' => ['title' => 'إجراءات مبيعات معلقة', 'meta' => ':requests طلب · :quotations عرض سعر · :orders أمر'],
            'pending_purchase_requests' => ['title' => 'طلبات شراء مفتوحة', 'meta' => 'بنود طلبات بها كمية لم تُطلب بعد'],
            'pending_purchase_sourcing' => ['title' => 'إجراءات توريد معلقة', 'meta' => 'طلبات عروض سعر أو عروض موردين أو اختيار مورد أو اعتماد اختيار بانتظار الإجراء'],
            'open_purchase_orders' => ['title' => 'أوامر شراء مفتوحة', 'meta' => ':partial مستلم جزئيًا · :overdue بند توريد متأخر'],
            'maintenance_breakdowns' => ['title' => 'أعطال مفتوحة', 'meta' => ':stopped بلاغ أوقف ماكينة'],
            'maintenance_overdue' => ['title' => 'صيانة متأخرة', 'meta' => 'أوامر واستحقاقات صيانة تجاوزت الموعد'],
            'pending_finance_approvals' => ['title' => 'اعتمادات مالية معلقة', 'meta' => 'مستندات مالية مسودة تنتظر الاعتماد'],
            'due_receivables' => ['title' => 'مديونيات العملاء المستحقة والمتأخرة', 'meta' => 'أقساط عملاء لها رصيد ومستحقة حتى تاريخ لوحة المتابعة'],
            'due_payables' => ['title' => 'مديونيات الموردين المستحقة والمتأخرة', 'meta' => 'أقساط موردين لها رصيد ومستحقة حتى تاريخ لوحة المتابعة'],
            'due_cheques' => ['title' => 'شيكات مستحقة', 'meta' => 'شيكات غير منتهية الحالة مستحقة حتى تاريخ اللوحة'],
            'returned_cheques' => ['title' => 'شيكات مرتدة', 'meta' => 'شيكات حالتها الحالية مرتدة'],
        ],
        'charts' => [
        ...
        'limitations' => [
            ...
            'reorder_setup_missing' => 'مؤشر المخزون المنخفض غير متاح لعدم ضبط حد إعادة الطلب لأي صنف مخزني نشط.',
            'inventory_store_missing' => 'مؤشر المخزون المنخفض غير متاح لعدم وجود مخزن مضبوط للفرع الحالي.',
            'sales_currency_missing' => 'مؤشر إجراءات المبيعات المعلقة غير متاح لعدم ضبط عملة تقارير نشطة.',
        ],
    ],
    'expanded' => [
