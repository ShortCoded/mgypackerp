...
return [
    ...
    'summaries' => [
        'title' => 'الملخصات',
        'hint' => 'افتح هذا القسم لتحميل ملخصات المبيعات والمشتريات الحالية.',
        'sales' => 'ملخص المبيعات',
        'purchases' => 'ملخص المشتريات',
        'branch' => 'الفرع',
        'financial_period' => 'الفترة المالية',
        'currency' => 'العملة',
        'all_currencies' => 'كل العملات (للأعداد فقط)',
        'date_from' => 'من',
        'date_to' => 'إلى',
        'refresh' => 'تحديث',
        'loading' => 'جارٍ تحميل الملخص...',
        'empty' => 'لا توجد بيانات ملخص لهذه المرشحات.',
        'failed' => 'تعذر تحميل الملخص.',
        'context_required' => 'اختر الشركة والفرع والفترة المالية أولاً.',
        'date_outside_period' => 'يجب أن تقع التواريخ المحددة داخل الفترة المالية.',
        'currency_invalid' => 'اختر عملة نشطة للشركة الحالية.',
        'select_currency_for_value' => 'اختر عملة',
        'count_only' => 'العدد عبر العملات؛ اختر عملة واحدة لعرض القيم.',
        'return_value' => 'قيمة المرتجعات: :value :currency',
        'metrics' => [
            'sales_orders' => 'أوامر البيع', 'sales_invoices' => 'فواتير المبيعات المرحلة',
            'sales_value' => 'قيمة المبيعات المفوترة', 'sales_returns' => 'مرتجعات المبيعات',
            'sales_outstanding' => 'مديونية العملاء', 'purchase_orders' => 'أوامر الشراء',
            'purchase_invoices' => 'فواتير المشتريات', 'purchase_value' => 'قيمة المشتريات',
            'purchase_returns' => 'مرتجعات المشتريات', 'purchase_outstanding' => 'مديونية الموردين',
        ],
    ],
