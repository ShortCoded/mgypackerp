...
return [
    ...
    'attributes' => [
        ...
        'production_order_doc_num' => 'أمر الإنتاج',
        'lines.*.production_order_line_public_id' => 'بند أمر الإنتاج',
        'lines.*.production_order_line_id' => 'بند أمر الإنتاج',
        'lines.*.production_order_stage_snapshot_public_id' => 'مرحلة الإنتاج',
        'lines.*.production_order_stage_snapshot_id' => 'مرحلة الإنتاج',
        'lines.*.planned_quantity' => 'الكمية المخططة',
        'production_machine_public_id' => 'ماكينة الإنتاج',
