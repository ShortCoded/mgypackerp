                    ...
                    <form class="js-purchase-invoice-document-number-settings-form" action="{{ route('admin.purchases.purchase-invoices.document-number-settings.update') }}" method="POST" novalidate>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <x-forms.input class="form-control" id="purchase-invoices-document-prefix" name="prefix" type="text" maxlength="20" value="{{ $documentNumberSettings['prefix'] ?? '' }}" />
                            ...
                            <div class="col-md-3 col-lg-2">
                                ...
                                <x-forms.input class="form-control" id="purchase-invoices-document-padding" name="padding" type="number" min="0" max="10" step="1" value="{{ $documentNumberSettings['padding'] ?? 5 }}" required />
                ...
                <div class="col-12 col-lg-auto ms-auto d-flex flex-wrap justify-content-lg-end align-items-center gap-2">
                    @can('purchase_invoices.view_trashed')
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <x-forms.select class="form-select form-select-sm w-auto js-purchase-invoice-filter" id="purchase_invoices_trash_filter" name="trash_filter" aria-label="{{ __('purchase_invoices.filters.trash') }}">
                    ...
                    @if(auth()->user()?->can('purchase_invoices.delete'))
                        <div class="d-none align-items-center gap-2 purchase-invoice-bulk-actions-bar" id="bulk_actions_bar">
                            ...
                            <x-forms.select class="form-select form-select-sm w-auto" id="bulk_action_select" aria-label="{{ __('purchase_invoices.bulk_action') }}">
                                ...
                                <tr>
                                    <th class="text-900 no-sort white-space-nowrap align-middle all no-colvis dt-select" data-orderable="false" style="width: 2.25rem;">
                                        <div class="form-check mb-0 d-flex align-items-center justify-content-center">
                                            <x-forms.input class="form-check-input js-record-select-all" type="checkbox" id="select_all_records" aria-label="{{ __('purchase_invoices.select_all') }}" />
                                        </div>
                                    </th>
