        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <x-forms.select class="js-payment-supplier" id="supplier_doc_num" name="supplier_doc_num" variant="ajax" :url="route('admin.purchases.select2.suppliers')" :placeholder="__('Select')" :allow-clear="false" required>
                ...
                <div class="col-md-3">
                    ...
                    <x-forms.select class="js-payment-method" id="payment_method" name="payment_method" variant="local" :allow-clear="false" required>
                ...
                <div class="col-md-3">
                    ...
                    <x-forms.select id="currency_doc_num" name="currency_doc_num" variant="local" :allow-clear="false" required>
                ...
                <div class="col-md-3 js-cash-source">
                    ...
                    <x-forms.select id="cashbox_doc_num" name="cashbox_doc_num" variant="local">
                        <option value="">{{ __('Select') }}</option>
                ...
                <div class="col-md-6 js-bank-source d-none">
                    ...
                    <x-forms.select id="bank_account_doc_num" name="bank_account_doc_num" variant="local">
                        <option value="">{{ __('Select') }}</option>
                ...
                <div class="col-md-3">
                    ...
                    <x-forms.select id="purchase_order_doc_num" name="purchase_order_doc_num" variant="ajax" :url="route('admin.purchases.select2.supplier-payment-purchase-orders')" :placeholder="__('None')">
                        <option value="">{{ __('None') }}</option>
                        @if($selectedPurchaseOrder)
                            <option value="{{ $selectedPurchaseOrder->doc_num }}" selected>{{ $selectedPurchaseOrder->doc_num }}</option>
                        @endif
                    </x-forms.select>
                </div>
