        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.fixed-assets.reports.index') }}" class="row g-3 align-items-end">
                <div class="col-12 col-md-6 col-xl-3">
                    ...
                    <x-forms.select class="form-select" id="fixed-asset-report-type" name="type">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    ...
                    <x-forms.select class="form-select js-select2-ajax" id="fixed-asset-report-period" name="financial_period_doc_num" data-url="{{ route('admin.select2.financial-periods') }}" data-placeholder="{{ __('fixed_assets.placeholders.financial_period') }}" data-allow-clear="true">
                ...
                <div class="col-12 col-md-6 col-xl-2">
                    ...
                    <x-forms.select class="form-select js-select2-ajax" id="fixed-asset-report-asset" name="asset_doc_num" data-url="{{ route('admin.fixed-assets.select2.assets') }}" data-placeholder="{{ __('fixed_assets.placeholders.asset') }}" data-allow-clear="true">
                ...
                <div class="col-12">
                    <details class="fa-report-advanced border rounded-2" @if($advancedOpen) open @endif>
                        ...
                        <div class="row g-3 px-3 pb-3 pt-1">
                            <div class="col-12 col-md-6 col-xl-3"><label class="form-label" for="fixed-asset-report-category">{{ __('fixed_assets.attributes.asset_group_account') }}</label><x-forms.select class="form-select js-select2-ajax" id="fixed-asset-report-category" name="asset_group_account_doc_num" data-url="{{ route('admin.fixed-assets.select2.asset-categories') }}" data-placeholder="{{ __('fixed_assets.placeholders.asset_category') }}" data-allow-clear="true">@if($filters['asset_group_account_doc_num'] ?? null)<option value="{{ $filters['asset_group_account_doc_num'] }}" selected>{{ $filters['asset_group_account_doc_num'] }}</option>@endif</x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3"><label class="form-label" for="fixed-asset-report-entry-type">{{ __('fixed_assets.attributes.entry_type') }}</label><x-forms.select class="form-select" id="fixed-asset-report-entry-type" name="entry_type"><option value=""></option>@foreach(\Modules\FixedAssets\Models\FixedAsset::entryTypes() as $entryType)<option value="{{ $entryType }}" @selected(($filters['entry_type'] ?? null) === $entryType)>{{ __('fixed_assets.entry_types.'.$entryType) }}</option>@endforeach</x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3"><label class="form-label" for="fixed_asset_report_branch">{{ __('fixed_assets.attributes.branch') }}</label><x-forms.select class="form-select js-select2-ajax" id="fixed_asset_report_branch" name="branch_doc_num" data-url="{{ route('admin.fixed-assets.select2.branches') }}" data-placeholder="{{ __('fixed_assets.placeholders.branch') }}" data-allow-clear="true">@if($filters['branch_doc_num'] ?? null)<option value="{{ $filters['branch_doc_num'] }}" selected>{{ $filters['branch_doc_num'] }}</option>@endif</x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3"><label class="form-label" for="fixed-asset-report-hall">{{ __('fixed_assets.attributes.hall') }}</label><x-forms.select class="form-select js-select2-ajax" id="fixed-asset-report-hall" name="branch_hall_uuid" data-url="{{ route('admin.fixed-assets.select2.branch-halls') }}" data-placeholder="{{ __('fixed_assets.placeholders.hall') }}" data-depends-on="#fixed_asset_report_branch" data-dependent-param="branch_doc_num" data-disable-when-dependency-empty="true" data-allow-clear="true">@if($filters['branch_hall_uuid'] ?? null)<option value="{{ $filters['branch_hall_uuid'] }}" selected>{{ $filters['branch_hall_uuid'] }}</option>@endif</x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3"><label class="form-label" for="fixed-asset-report-cost-center">{{ __('fixed_assets.attributes.cost_center') }}</label><x-forms.select class="form-select js-select2-ajax" id="fixed-asset-report-cost-center" name="cost_center_doc_num" data-url="{{ route('admin.fixed-assets.select2.cost-centers') }}" data-placeholder="{{ __('fixed_assets.placeholders.cost_center') }}" data-allow-clear="true">@if($filters['cost_center_doc_num'] ?? null)<option value="{{ $filters['cost_center_doc_num'] }}" selected>{{ $filters['cost_center_doc_num'] }}</option>@endif</x-forms.select></div>
                            ...
                            <div class="col-12 col-md-6 col-xl-3"><label class="form-label" for="fixed-asset-report-depreciable">{{ __('fixed_assets.attributes.is_depreciable') }}</label><x-forms.select class="form-select" id="fixed-asset-report-depreciable" name="depreciable"><option value=""></option><option value="1" @selected(($filters['depreciable'] ?? null) === '1')>{{ __('fixed_assets.booleans.yes') }}</option><option value="0" @selected(($filters['depreciable'] ?? null) === '0')>{{ __('fixed_assets.booleans.no') }}</option></x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3" data-report-types="depreciation"><label class="form-label" for="fixed-asset-report-posting-status">{{ __('fixed_assets.pdf.filters.posting_status') }}</label><x-forms.select class="form-select" id="fixed-asset-report-posting-status" name="posting_status"><option value=""></option>@foreach([\Modules\FixedAssets\Models\FixedAssetDepreciation::StatusPosted, \Modules\FixedAssets\Models\FixedAssetDepreciation::StatusReversed] as $postingStatus)<option value="{{ $postingStatus }}" @selected(($filters['posting_status'] ?? null) === $postingStatus)>{{ __('fixed_assets.lifecycle.statuses.'.$postingStatus) }}</option>@endforeach</x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3" data-report-types="movements"><label class="form-label" for="fixed-asset-report-movement-type">{{ __('fixed_assets.cycle.type') }}</label><x-forms.select class="form-select" id="fixed-asset-report-movement-type" name="movement_type"><option value=""></option>@foreach(\Modules\FixedAssets\Services\FixedAssetLedgerService::types() as $movementType)<option value="{{ $movementType }}" @selected(($filters['movement_type'] ?? null) === $movementType)>{{ __('fixed_assets.cycle.'.$movementType) }}</option>@endforeach</x-forms.select></div>
                            <div class="col-12 col-md-6 col-xl-3" data-report-types="movements"><label class="form-label" for="fixed-asset-report-user">{{ __('fixed_assets.cycle.user') }}</label><x-forms.input class="form-control" id="fixed-asset-report-user" name="user" value="{{ $filters['user'] ?? '' }}" placeholder="{{ __('fixed_assets.product.user_filter_help') }}" /></div>
                        </div>
                    </details>
                </div>
