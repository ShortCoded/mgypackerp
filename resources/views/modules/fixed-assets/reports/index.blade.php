        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.fixed-assets.reports.index') }}" class="row g-3 align-items-end">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    ...
                    <select class="form-select js-select2-ajax" id="fixed-asset-report-period" name="financial_period_doc_num" data-url="{{ route('admin.select2.financial-periods') }}" data-placeholder="{{ __('fixed_assets.placeholders.financial_period') }}" data-allow-clear="true">
                ...
                <div class="col-12 col-md-6 col-xl-2">
                    ...
                    <select class="form-select js-select2-ajax" id="fixed-asset-report-asset" name="asset_doc_num" data-url="{{ route('admin.fixed-assets.select2.assets') }}" data-placeholder="{{ __('fixed_assets.placeholders.asset') }}" data-allow-clear="true">
