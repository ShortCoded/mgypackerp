    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.fixed-assets.reports.index') }}" class="row g-3 align-items-end">
                ...
                <div class="col-md-4 col-xl-3"><label class="form-label">{{ __('fixed_assets.reports.from_date') }}</label><input class="form-control js-date-picker" name="from_date" value="{{ request('from_date') }}" data-date-format="{{ $dates->jsDateFormat() }}" data-locale="{{ app()->getLocale() }}"></div>
                <div class="col-md-4 col-xl-3"><label class="form-label">{{ __('fixed_assets.reports.to_date') }}</label><input class="form-control js-date-picker" name="to_date" value="{{ request('to_date') }}" data-date-format="{{ $dates->jsDateFormat() }}" data-locale="{{ app()->getLocale() }}"></div>
