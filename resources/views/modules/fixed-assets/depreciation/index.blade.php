    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.fixed-assets.depreciation.preview') }}" class="row g-3 align-items-end">@csrf
                ...
                <div class="col-md-4 col-xl-3"><label class="form-label" for="depreciation-posting_date">{{ __('fixed_assets.usability.depreciation_month_end') }}</label><input id="depreciation-posting_date" class="form-control js-date-picker" name="posting_date" value="{{ $dates->formatDate($dates->normalizeForStorage(old('posting_date', $postingDate)), '') }}" data-date-format="{{ $dates->jsDateFormat() }}" data-locale="{{ app()->getLocale() }}" required><div class="form-text">{{ __('fixed_assets.usability.depreciation_month_end_help') }}</div></div>
                <div class="col-md-4 col-xl-3"><label class="form-label" for="depreciation-branch_doc_num">{{ __('fixed_assets.attributes.branch') }}</label><select id="depreciation-branch_doc_num" class="form-select js-select2-ajax" name="branch_doc_num" data-url="{{ route('admin.fixed-assets.select2.branches') }}" data-placeholder="{{ __('fixed_assets.placeholders.branch') }}" data-allow-clear="true"></select></div>
                <div class="col-md-4 col-xl-3"><label class="form-label" for="depreciation-asset_group_account_doc_num">{{ __('fixed_assets.attributes.asset_group_account') }}</label><select id="depreciation-asset_group_account_doc_num" class="form-select js-select2-ajax" name="asset_group_account_doc_num" data-url="{{ route('admin.fixed-assets.select2.asset-categories') }}" data-placeholder="{{ __('fixed_assets.placeholders.asset_category') }}" data-allow-clear="true"></select></div>
                <div class="col-md-4 col-xl-3"><label class="form-label" for="depreciation-cost_center_doc_num">{{ __('fixed_assets.attributes.cost_center') }}</label><select id="depreciation-cost_center_doc_num" class="form-select js-select2-ajax" name="cost_center_doc_num" data-url="{{ route('admin.fixed-assets.select2.cost-centers') }}" data-placeholder="{{ __('fixed_assets.placeholders.cost_center') }}" data-allow-clear="true"></select></div>
