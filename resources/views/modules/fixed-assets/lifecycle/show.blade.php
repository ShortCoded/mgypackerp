        ...
        <form class="fa-attachment-zone m-3 p-3" method="POST" action="{{ route('admin.fixed-assets.movements.document', $asset) }}">@csrf
            <div class="row g-2 align-items-end">
                <div class="col-12 col-lg-5">
                    ...
                    <x-forms.select class="form-select js-asset-document-target" id="asset-document-target" name="document_target" required>
                ...
                <div class="col-12 col-lg">
                    ...
                    <x-forms.input type="hidden" id="asset-document-file" name="archive_file_doc_num" required />
