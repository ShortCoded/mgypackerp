...
@section('content')
    <form class="js-fixed-asset-form js-crud-form" action="{{ $action }}" method="{{ $method }}" data-financial-locked="{{ $financialLocked ? 1 : 0 }}" data-primary-focus="asset_name" data-mode="{{ $mode }}" data-main-currency-doc-num="{{ $defaults['main_currency_doc_num'] ?? '' }}" novalidate>
        ...
        @if($sourceType)
            ...
            <x-forms.input type="hidden" name="source_id" value="{{ $sourceId }}" />
            <x-forms.input type="hidden" name="source_doc_num" value="{{ $sourceDocNum }}" />
        @endif
        @if($cloneSourceToken)
                        ...
                        <div class="row g-3">
                            @if($canControlDocumentNumber)
                                <div class="col-lg-3" data-layout-row="basic-identity">
                                    ...
                                    @else
                                        <x-forms.input class="text-center form-control" id="doc_number" name="doc_number" type="number" min="0" step="1" inputmode="numeric" value="{{ $documentNumberValue }}" placeholder="{{ __('item_lookups.document_number_control.placeholder') }}" />
                                    @endif
                            ...
                            <div class="col-lg-3" data-layout-row="basic-identity">
                                ...
                                @else
                                    <x-forms.select class="form-select js-fixed-asset-entry-type" id="entry_type" name="entry_type" required>
                            ...
                            <div class="col-lg-3" data-layout-row="basic-identity">
                                ...
                                @else
                                    <x-forms.date-input class="form-control js-date-picker" id="asset_date" name="asset_date" type="text" value="{{ $dateValue('asset_date') }}" data-date-format="{{ $dateFormatService->jsDateFormat() }}" data-locale="{{ app()->getLocale() }}" placeholder="{{ __('common.placeholders.select_date') }}" autocomplete="off" dir="ltr" required />
                                @endif
                            ...
                            <div class="{{ $canControlDocumentNumber || ! $isCreateLike ? 'col-lg-3' : 'col-lg-6' }}" data-layout-row="basic-identity">
                                ...
                                @else
                                    <x-forms.input class="form-control" id="asset_name" name="asset_name" value="{{ $value('asset_name') }}" autofocus required />
                                @endif
                            ...
                            <div class="mb-4 col-12 fixed-asset-image-field" data-layout-row="basic-image">
                                ...
                                @unless($isView)
                                    <x-forms.input type="hidden" id="fixed-asset-image-archive-file" name="image_archive_file_doc_num" value="{{ $selectedImagePublicId }}" />
                                    <x-forms.input type="hidden" id="fixed-asset-remove-image" name="remove_image" value="{{ $removeImageRequested && ! $selectedImageFile ? '1' : '0' }}" />
                                @endunless
                            ...
                            <div class="col-xl-3 col-lg-6" data-layout-row="basic-dates">
                                ...
                                @else
                                    <x-forms.input class="form-control" id="serial_number" name="serial_number" value="{{ $value('serial_number') }}" />
                                @endif
                            ...
                            <div class="col-xl-3 col-lg-6" data-layout-row="basic-accounts">
                                ...
                                @else
                                    <div class="fixed-asset-select-control">
                                        <x-forms.select class="form-select js-select2-ajax" id="asset_group_account_doc_num" name="asset_group_account_doc_num" data-url="{{ route('admin.fixed-assets.select2.asset-categories') }}" data-placeholder="{{ __('fixed_assets.placeholders.asset_category') }}" data-allow-clear="true" required>
                            ...
                            <div class="col-xl-3 col-lg-6" data-layout-row="basic-accounts">
                                ...
                                @elseif($linkedPurchaseLine)
                                    <x-forms.input type="hidden" name="credit_account_doc_num" value="{{ $creditAccountOption['id'] ?? '' }}" />
                                    <x-forms.view-field for="credit_account_doc_num" :value="$creditAccountOption['text'] ?? null" />
                                @else
                                    <x-forms.select class="form-select js-select2-ajax" id="credit_account_doc_num" name="credit_account_doc_num" data-url="{{ route('admin.fixed-assets.select2.credit-accounts') }}" data-placeholder="{{ __('fixed_assets.placeholders.credit_account') }}" data-allow-clear="true" required>
                            ...
                            <div class="col-xl-3 col-lg-6" data-layout-row="basic-accounts">
                                ...
                                @else
                                    <x-forms.select class="form-select js-select2-ajax" id="cost_center_doc_num" name="cost_center_doc_num" data-url="{{ route('admin.fixed-assets.select2.cost-centers') }}" data-placeholder="{{ __('fixed_assets.placeholders.cost_center') }}" data-allow-clear="true">
                    ...
                    <div class="tab-pane fade" id="fixed-asset-financial-tab" role="tabpanel">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                @else
                                    <x-forms.select class="form-select js-select2-ajax js-fixed-asset-currency" id="currency_doc_num" name="currency_doc_num" data-url="{{ route('admin.fixed-assets.select2.currencies') }}" data-placeholder="{{ __('fixed_assets.placeholders.currency') }}" data-allow-clear="true" required>
                            ...
                            <div class="col-md-4">
                                ...
                                @else
                                    <x-forms.select class="form-select js-fixed-asset-is-depreciable" id="is_depreciable" name="is_depreciable" required>
                            ...
                            <div class="col-md-4">
                                ...
                                @else
                                    <x-forms.select class="form-select js-fixed-asset-depreciation-control js-fixed-asset-depreciation-method" id="depreciation_method" name="depreciation_method" data-default-method="{{ $fixedAssetClass::DepreciationMethodStraightLine }}" :required='$isDepreciableSelected' :disabled='! $isDepreciableSelected'>
                            ...
                            <div class="col-md-4">
                                ...
                                <x-forms.input class="text-center form-control js-fixed-asset-net-value" id="net_value" data-master-locked="{{ $financialLocked ? 1 : 0 }}" type="text" value="{{ $numbers->format($numericValue('net_value')) }}" dir="ltr" readonly />
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                @else
                                    <x-forms.date-input class="form-control js-date-picker" name="depreciation_start_date" id="depreciation_start_date" value="{{ $dateValue('depreciation_start_date') }}" data-date-format="{{ $dateFormatService->jsDateFormat() }}" data-locale="{{ app()->getLocale() }}" />
                                @endif
                    ...
                    <div class="tab-pane fade" id="fixed-asset-location-tab" role="tabpanel">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                ...
                                @else
                                    <x-forms.select class="form-select js-select2-ajax js-fixed-asset-branch" id="branch_doc_num" name="branch_doc_num" data-url="{{ route('admin.fixed-assets.select2.branches') }}" data-placeholder="{{ __('fixed_assets.placeholders.branch') }}" data-allow-clear="true" required>
                            ...
                            <div class="col-12">
                                ...
                                @else
                                    <x-forms.textarea class="form-control" id="location_address" name="location_address" rows="2">{{ $value('location_address') }}</x-forms.textarea>
                                @endif
                            ...
                            <div class="col-12">
                                ...
                                @else
                                    <x-forms.textarea class="form-control" id="description" name="description" rows="3" required>{{ $value('description') }}</x-forms.textarea>
                                @endif
                ...
                <form class="modal-content js-fixed-asset-inline-form" action="{{ route('admin.fixed-assets.assets.asset-categories.store') }}" method="POST" data-target-select="#asset_group_account_doc_num" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <x-forms.input class="form-control" id="fixed_asset_category_name" name="name" type="text" required />
                            <div class="invalid-feedback" data-error-for="name"></div>
                        </div>
                        <div>
                            <label class="form-label" for="fixed_asset_category_notes">{{ __('fixed_assets.attributes.notes') }}</label>
                            <x-forms.textarea class="form-control" id="fixed_asset_category_notes" name="notes" rows="3"></x-forms.textarea>
                            <div class="invalid-feedback" data-error-for="notes"></div>
                        </div>
                    </div>
