                    ...
                    <form id="products-document-number-settings-form" action="{{ $routes['document_number_settings'] }}" method="POST" novalidate>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <x-forms.input class="form-control" id="products-document-prefix" name="prefix" type="text" maxlength="20" value="{{ $documentNumberSettings['prefix'] ?? '' }}" />
                            ...
                            <div class="col-md-3 col-lg-2">
                                ...
                                <x-forms.input class="form-control" id="products-document-padding" name="padding" type="number" min="0" max="10" step="1" value="{{ $documentNumberSettings['padding'] ?? 5 }}" />
                                ...
                                <tr>
                                    <th class="text-900 no-sort white-space-nowrap align-middle all no-colvis dt-select" data-orderable="false" data-searchable="false" style="width: 2.25rem;">
                                        <div class="form-check mb-0 d-flex align-items-center justify-content-center">
                                            <x-forms.input class="form-check-input js-record-select-all" type="checkbox" id="select_all_records" aria-label="{{ $resourceSelectAllLabel }}" />
                                        </div>
                                    </th>
