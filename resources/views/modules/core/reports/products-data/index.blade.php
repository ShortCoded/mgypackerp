    ...
    >
        ...
        >
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                ...
                <x-forms.select class="{{ $staticSelectClass }}" id="product-data-result-mode" name="result_mode" data-filter-label="{{ __('product_data_report.filters.result_mode') }}" data-placeholder="{{ __('product_data_report.filters.result_mode') }}" data-allow-clear="false">
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                ...
                <x-forms.select class="{{ $staticSelectClass }}" id="product-data-item-scope" name="item_scope" data-filter-label="{{ __('product_data_report.filters.item_scope') }}" data-placeholder="{{ __('product_data_report.filters.item_scope') }}" data-allow-clear="false">
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                ...
                <x-forms.select class="{{ $staticSelectClass }}" id="product-data-record-state" name="record_state" data-filter-label="{{ __('product_data_report.filters.record_state') }}" data-placeholder="{{ __('product_data_report.filters.record_state') }}" data-allow-clear="false">
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                ...
                <x-forms.select class="{{ $staticSelectClass }}" id="product-data-status" name="status" data-filter-label="{{ __('product_data_report.filters.status') }}" data-placeholder="{{ __('product_data_report.options.all') }}" data-allow-clear="true">
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                ...
                <x-forms.select class="{{ $staticSelectClass }}" id="product-data-components-state" name="components_state" data-filter-label="{{ __('product_data_report.filters.components_state') }}" data-placeholder="{{ __('product_data_report.filters.components_state') }}" data-allow-clear="false">
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                <label class="form-label mb-1" for="product-data-product">{{ __('product_data_report.filters.product') }}</label>
                                    <x-forms.select class="{{ $ajaxSelectClass }}" id="product-data-product" name="product_doc_num" data-filter-label="{{ __('product_data_report.filters.product') }}" data-url="{{ route('admin.reports.products-data.filter-options.products') }}" data-placeholder="{{ __('product_data_report.placeholders.select_product') }}" data-allow-clear="true" :data-extra-params="json_encode(['item_scope' => '#product-data-item-scope'])">
                    <option value=""></option>
                </x-forms.select>
            </div>
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                <label class="form-label mb-1" for="product-data-doc-num">{{ __('product_data_report.filters.doc_num') }}</label>
                <x-forms.input class="form-control form-control-sm js-report-filter-control" id="product-data-doc-num" name="doc_num" type="text" data-filter-label="{{ __('product_data_report.filters.doc_num') }}" placeholder="{{ __('product_data_report.placeholders.doc_num') }}" dir="ltr" />
            </div>
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                <label class="form-label mb-1" for="product-data-name">{{ __('product_data_report.filters.name') }}</label>
                <x-forms.input class="form-control form-control-sm js-report-filter-control" id="product-data-name" name="name" type="text" data-filter-label="{{ __('product_data_report.filters.name') }}" placeholder="{{ __('product_data_report.placeholders.name') }}" />
            </div>
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                <label class="form-label mb-1" for="product-data-barcode">{{ __('product_data_report.filters.barcode') }}</label>
                <x-forms.input class="form-control form-control-sm js-report-filter-control" id="product-data-barcode" name="barcode" type="text" data-filter-label="{{ __('product_data_report.filters.barcode') }}" placeholder="{{ __('product_data_report.placeholders.barcode') }}" dir="ltr" />
            </div>
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                <label class="form-label mb-1" for="product-data-classification">{{ __('product_data_report.filters.item_classification') }}</label>
                <x-forms.select class="{{ $staticSelectClass }}" id="product-data-classification" name="item_classification" data-filter-label="{{ __('product_data_report.filters.item_classification') }}" data-placeholder="{{ __('product_data_report.options.all') }}" data-allow-clear="true">
                    <option value=""></option>
            ...
            @foreach ([
                ...
                <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                    ...
                    <x-forms.select class="{{ $ajaxSelectClass }}" id="product-data-{{ $lookup['id'] }}" name="{{ $lookup['name'] }}" data-filter-label="{{ $lookup['label'] }}" data-url="{{ $lookup['url'] }}" data-placeholder="{{ __('product_data_report.placeholders.select_lookup') }}" data-allow-clear="true">
                        <option value=""></option>
                    </x-forms.select>
                </div>
            @endforeach
            ...
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                ...
                <x-forms.select class="{{ $ajaxSelectClass }}" id="product-data-component-product" name="component_product_doc_num" data-filter-label="{{ __('product_data_report.filters.component_product') }}" data-url="{{ route('admin.reports.products-data.filter-options.components') }}" data-placeholder="{{ __('product_data_report.placeholders.select_component') }}" data-allow-clear="true">
                    <option value=""></option>
                </x-forms.select>
            </div>
            <div class="col-12 col-md-6 col-xl-3 report-filter-field">
                <label class="form-label mb-1" for="product-data-component-unit">{{ __('product_data_report.filters.component_unit') }}</label>
                <x-forms.select class="{{ $ajaxSelectClass }}" id="product-data-component-unit" name="component_unit_doc_num" data-filter-label="{{ __('product_data_report.filters.component_unit') }}" data-url="{{ route('admin.select2.item-units') }}" data-placeholder="{{ __('product_data_report.placeholders.select_lookup') }}" data-allow-clear="true">
                    <option value=""></option>
                </x-forms.select>
            </div>
