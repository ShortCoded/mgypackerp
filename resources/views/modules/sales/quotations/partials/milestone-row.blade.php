...
<td>
    ...
    @else
        <x-forms.input class="form-control" name="payment_milestones[{{ $index }}][title]" type="text" value="{{ $row['title'] ?? '' }}" />
...
<td>
    ...
    @else
        <x-forms.input class="form-control" name="payment_milestones[{{ $index }}][description]" type="text" value="{{ $row['description'] ?? '' }}" />
    @endif
</td>
<td>
    @if ($isReadonly)
...
<td>
    ...
    @else
        <x-forms.select class="form-select" name="payment_milestones[{{ $index }}][due_type]">
...
<td>
    ...
    @else
        <x-forms.date-input class="form-control text-center js-date-picker" name="payment_milestones[{{ $index }}][due_date]" type="text" value="{{ $row['due_date'] ?? '' }}" data-date-format="{{ $dates->jsDateFormat() }}" data-locale="{{ app()->getLocale() }}" autocomplete="off" dir="ltr" />
    @endif
</td>
<td>
    @if ($isReadonly)
    ...
    @else
        <x-forms.input class="form-control" name="payment_milestones[{{ $index }}][notes]" type="text" value="{{ $row['notes'] ?? '' }}" />
    @endif
</td>
@unless ($isReadonly)
