            ...
            <tbody>
                @forelse($customers as $customer)
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-3">@can('customers.edit')<a class="btn btn-falcon-primary btn-sm white-space-nowrap" href="{{ route('admin.sales.customer-terms.edit', $customer) }}"><span class="fas fa-sliders-h me-1"></span>{{ __('customer_terms.edit_action') }}</a>@endcan</td>
                    </tr>
                @empty
