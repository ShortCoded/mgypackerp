...
<tr data-sales-line>
    ...
    <td>
        ...
        <input class="form-control form-control-sm mt-1" name="lines[{{ $index }}][description]" value="{{ $line['description'] ?? '' }}" placeholder="{{ __('Line description') }}">
    ...
    <td><input class="form-control form-control-sm js-date-picker" name="lines[{{ $index }}][requested_date]" value="{{ app(\Modules\Core\Services\DateFormatService::class)->formatDate($line['requested_date'] ?? null, '') }}"></td>
