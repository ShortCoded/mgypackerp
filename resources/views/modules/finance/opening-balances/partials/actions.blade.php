    ...
    <div class="dropdown-menu dropdown-menu-end border py-0">
        <div class="py-2">
            @can('opening_balances.view')
                <a class="dropdown-item" href="{{ $record->trashed() ? route('admin.finance.opening-balances.trashed.show', $record->doc_num) : route('admin.finance.opening-balances.show', $record->doc_num) }}">{{ __('common.actions.view') }}</a>
            @endcan
            @if($record->trashed())
