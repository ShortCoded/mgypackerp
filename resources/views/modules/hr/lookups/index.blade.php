...
@section('content')
        ...
        <div class="card mb-3">
            ...
            <div class="collapse" id="{{ $definition->routeKey }}-document-number-settings">
                <div class="card-body">
                    ...
                    <form class="js-hr-document-number-settings-form"
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <input class="form-control" id="{{ $definition->routeKey }}-document-prefix" name="prefix" type="text" maxlength="20" value="{{ $documentNumberSettings['prefix'] ?? '' }}">
                            ...
                            <div class="col-md-3 col-lg-2">
                                ...
                                <input class="form-control" id="{{ $definition->routeKey }}-document-padding" name="padding" type="number" min="0" max="10" step="1" value="{{ $documentNumberSettings['padding'] ?? 0 }}" required>
    ...
    <div class="card erp-datatable-card hr-lookup-datatable-card">
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">{{ __('hr.' . $definition->translationKey . '.title') }}</h5>
                </div>
                <div class="col-6 col-sm-auto ms-auto text-end ps-0 d-flex justify-content-end align-items-center gap-2 hr-lookup-toolbar-actions">
                    @can($definition->permission('view_trashed'))
                        <div class="d-flex align-items-center gap-2">
                            <label class="form-label mb-0 text-700 fs-10" for="hr_lookup_trash_filter">{{ __('hr.trash.filter_label') }}</label>
                            <select class="form-select form-select-sm w-auto" id="hr_lookup_trash_filter" aria-label="{{ __('hr.trash.filter_label') }}">
                    ...
                    @can($definition->permission('delete'))
                        <div class="d-none align-items-center gap-2 hr-lookup-bulk-actions-bar" id="bulk_actions_bar">
            ...
            <div class="falcon-data-table">
                <div class="erp-datatable-wrapper">
                    <div class="erp-datatable-scroll">
                        <table class="table table-sm table-hover mb-0 data-table erp-datatable align-middle js-hr-lookup-table" id="hr-{{ $definition->routeKey }}-table"
