...
@section('content')
    <div class="production-mobile-workflow" data-client-report-tables>
        ...
        @elseif($section === 'quality')
            ...
            <div class="row g-3 mb-3">
                @foreach($qualitySummary as $key => $value)
                    <div class="col-sm-6 col-xl"><div class="card h-100"><div class="card-body py-3"><div class="fw-semi-bold text-700">{{ __('production_execution.reports.quality_kpis.'.$key) }}</div><div class="fs-4 fw-bold mt-1" dir="ltr">{{ $numbers->format($value) }}</div></div></div></div>
                @endforeach
            </div>
