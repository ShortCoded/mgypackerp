<div class="modal fade" id="{{ $modalId }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form class="modal-content js-business-location-inline-form" method="POST" novalidate>
            ...
            <x-forms.input type="hidden" name="parent_field" value="" />
            <x-forms.input type="hidden" name="parent_value" value="" />
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <x-forms.input class="form-control js-location-inline-name" id="{{ $modalId }}_name" name="name" type="text" required />
                    <div class="invalid-feedback" data-error-for="name"></div>
                </div>
                <div>
                    <label class="form-label" for="{{ $modalId }}_notes">{{ __('business_partners.attributes.notes') }}</label>
                    <x-forms.textarea class="form-control" id="{{ $modalId }}_notes" name="notes" rows="3"></x-forms.textarea>
