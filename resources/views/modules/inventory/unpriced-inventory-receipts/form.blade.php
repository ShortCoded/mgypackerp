                            ...
                            @forelse($existingLines as $index => $line)
                                ...
                                <tr class="js-unpriced-inventory-receipt-line" data-index="{{ $index }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <x-forms.numeric-input class="text-center js-unpriced-inventory-receipt-quantity" :name="'lines['.$index.'][quantity]'" :value="$line['quantity'] ?? ''" :scale="8" min="0.00000001" step="0.00000001" arrow-step="1" />
    ...
    @unless($isReadonly)
        <template id="unpriced-inventory-receipt-line-template">
            <tr class="js-unpriced-inventory-receipt-line" data-index="__INDEX__">
                ...
                <td class="text-center">
                    <x-forms.numeric-input class="text-center js-unpriced-inventory-receipt-quantity" name="lines[__INDEX__][quantity]" :scale="8" min="0.00000001" step="0.00000001" arrow-step="1" />
