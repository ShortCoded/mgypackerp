                    ...
                    <form class="js-unpriced-inventory-receipts-document-number-settings-form" action="{{ route($routePrefix.'.document-number-settings.update') }}" method="POST" novalidate>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <x-forms.input class="form-control" id="unpriced-inventory-receipts-document-prefix" name="prefix" type="text" maxlength="20" value="{{ $documentNumberSettings['prefix'] ?? '' }}" />
                            ...
                            <div class="col-md-3 col-lg-2">
                                ...
                                <x-forms.input class="form-control" id="unpriced-inventory-receipts-document-padding" name="padding" type="number" min="1" max="10" step="1" value="{{ $documentNumberSettings['padding'] ?? 5 }}" required />
                ...
                <div class="col-12 col-xl-auto ms-xl-auto text-end ps-xl-0 d-flex flex-wrap justify-content-end align-items-center gap-2">
                    ...
                    @can('inventory.unpriced_inventory_receipts.view_trashed')
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <x-forms.select class="form-select form-select-sm w-auto js-unpriced-inventory-receipts-trash-filter" id="unpriced_inventory_receipts_trash_filter" aria-label="{{ __('business_partners.trash.filter_label') }}">
