                    ...
                    <form class="js-user-document-number-settings-form"
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <input class="form-control" id="users-document-prefix" name="prefix" type="text" maxlength="20" value="{{ $documentNumberSettings['prefix'] ?? '' }}">
                            ...
                            <div class="col-md-3 col-lg-2">
                                ...
                                <input class="form-control" id="users-document-padding" name="padding" type="number" min="0" max="10" step="1" value="{{ $documentNumberSettings['padding'] ?? 0 }}" required>
                                ...
                                <tr>
                                    <th class="text-900 no-sort white-space-nowrap align-middle all no-colvis dt-select" data-orderable="false" style="width: 2.25rem;">
                                        <div class="form-check mb-0 d-flex align-items-center justify-content-center">
                                            <input class="form-check-input user-select-all js-record-select-all" type="checkbox" id="select_all_records" aria-label="{{ __('users.select_all') }}">
                                        </div>
                                    </th>
