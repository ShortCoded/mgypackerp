...
<table class="report-table" style="margin-bottom:9px;"><tbody>
    ...
    @if($record->salesEmployee)<tr><th>{{ __('Sales representative') }}</th><td colspan="3">{{ $record->salesEmployee->doc_num }} / {{ $record->salesEmployee->full_name ?: $record->salesEmployee->name }}</td></tr>@endif
</tbody></table>
