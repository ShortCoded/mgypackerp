<li class="nav-item dropdown erp-notifications-menu" data-notifications-root>
    <a class="nav-link notification-indicator px-0 fa-icon-wait" id="navbarDropdownNotification" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="{{ __('notifications.title') }}" title="{{ __('notifications.title') }}" data-bs-title="{{ __('notifications.title') }}" data-hide-on-body-scroll="data-hide-on-body-scroll">
            ...
            <div class="card-header">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto d-flex align-items-center gap-2">
                        <span data-push-notification-control data-push-notification-compact>
