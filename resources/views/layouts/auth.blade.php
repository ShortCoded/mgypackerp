...
<head>
    @php
        $authBranding = app(\Modules\Core\Services\BrandingService::class)->current();
        $authPwaSettings = app(\Modules\Core\Services\PwaSettingsService::class)->settings();
    @endphp
    <meta charset="utf-8">
    ...
    <link href="{{ asset('assets/css/user.css') }}" rel="stylesheet" id="user-style-rtl">
