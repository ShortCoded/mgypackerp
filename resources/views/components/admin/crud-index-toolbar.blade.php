        ...
        <div class="col-12 col-sm-auto ms-sm-auto text-end d-flex flex-wrap justify-content-start justify-content-sm-end align-items-center gap-2 crud-index-toolbar-actions {{ $toolbarActionsClass }}">
            @if ($showTrashFilter)
                <div class="gap-2 d-flex align-items-center">
                    ...
                    <x-forms.select variant="local" :allow-clear="false" class="w-auto form-select form-select-sm" id="{{ $trashFilterId }}">
            ...
            @if ($showBulkActions)
                <div class="d-none align-items-center gap-2 {{ $bulkActionsClass }}" id="bulk_actions_bar">
                    ...
                    <x-forms.select variant="local" :allow-clear="false" class="w-auto form-select form-select-sm" id="bulk_action_select" aria-label="{{ $bulkActionLabel }}">
