...
return [
    ...
    'screens' => [
        $screen('customer-requests', 'Sales Requests', 'طلبات المبيعات', 'orders', 'document', ['shell_enabled' => false, 'classification' => 'CANONICAL', 'permission_prefix' => 'sales_requests', 'actions' => ['view', 'create', 'edit', 'approve', 'cancel', 'convert', 'print']]),
        $screen('sales-orders', 'Sales Orders', 'أوامر البيع', 'orders', 'document', ['shell_enabled' => false, 'classification' => 'CANONICAL', 'permission_prefix' => 'sales_orders', 'actions' => ['view', 'create', 'edit', 'approve', 'reject', 'cancel', 'reopen', 'print', 'view_prices', 'credit_override', 'reserve', 'deliver', 'invoice', 'production']]),
        $screen('sales-invoices', 'Sales Invoices', 'فواتير المبيعات', 'billing', 'document', ['shell_enabled' => false, 'classification' => 'CANONICAL', 'permission_prefix' => 'customer_invoices', 'actions' => ['view', 'create', 'edit', 'post', 'cancel', 'reopen', 'print', 'view_prices']]),
        ...
        $screen('delivery-notes', 'Delivery Notes', 'أذون التسليم', 'delivery', 'document', ['shell_enabled' => false, 'classification' => 'CANONICAL', 'permission_prefix' => 'sales_deliveries', 'actions' => ['view', 'create', 'print']]),
    ],
];
