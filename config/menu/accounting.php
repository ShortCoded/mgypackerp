    ...
    [
        ...
        'children' => [
            ...
            [
                ...
                'permission' => 'reports.general_journal.view',
                'keywords' => ['general journal', 'posted journal report', 'دفتر اليومية العامة', 'اليومية العامة'],
                'actions' => [
                    'view' => 'reports.general_journal.view',
                    'export' => 'reports.general_journal.export',
                ],
            ...
            [
                ...
                'permission' => 'reports.reconciliation_center.view',
                'keywords' => ['reconciliation', 'subledger', 'general ledger', 'مطابقة', 'فروقات'],
                'actions' => [
                    'view' => 'reports.reconciliation_center.view',
                    'export' => 'reports.reconciliation_center.export',
                ],
            ...
            [
                'label' => 'expense_analysis',
                'title' => 'Expense Analysis',
                'icon' => 'chart-area',
                'route' => 'admin.accounting.reports.financial-analytics.expense-analysis.index',
                'permission' => 'reports.financial_analytics.expense_analysis.view',
                'keywords' => ['expense analysis', 'cost center expenses', 'تحليل المصروفات', 'مصروفات مراكز التكلفة'],
                'actions' => [
                    'view' => 'reports.financial_analytics.expense_analysis.view',
                    'export' => 'reports.financial_analytics.expense_analysis.export',
                ],
                'active' => ['admin.accounting.reports.financial-analytics.expense-analysis.*'],
                'children' => [],
            ],
            [
                ...
                'icon' => 'percentage',
                'route' => 'admin.accounting.reports.financial-analytics.financial-ratios.index',
                'permission' => 'reports.financial_analytics.financial_ratios.view',
                'keywords' => ['financial ratios', 'current ratio', 'profit margin', 'inventory turnover', 'النسب المالية', 'هامش الربح'],
                'actions' => [
                    'view' => 'reports.financial_analytics.financial_ratios.view',
                    'export' => 'reports.financial_analytics.financial_ratios.export',
                ],
                'active' => ['admin.accounting.reports.financial-analytics.financial-ratios.*'],
                'children' => [],
            ],
            [
