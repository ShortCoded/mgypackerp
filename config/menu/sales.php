...
$salesReport = static function (string $label, string $title, string $reportType, string $icon = 'chart-bar'): array {
    ...
    return [
        ...
        'permission' => "reports.sales.{$reportType}.view",
        'subgroup' => in_array($reportType, $financialAnalysisTypes, true) ? 'financial_analysis_reports' : 'sales_cycle_reports',
        'actions' => [
            'view' => "reports.sales.{$reportType}.view",
            'export' => "reports.sales.{$reportType}.export",
            'print' => "reports.sales.{$reportType}.print",
        ],
    ...
    [
        ...
        'children' => [
            ...
            [
                ...
                'permission' => 'customer_terms.view',
                'keywords' => ['customer terms', 'quotation defaults', 'الشروط والأحكام', 'شروط العملاء'],
                'actions' => [
                    'view' => 'customer_terms.view',
                    'edit' => 'customer_terms.edit',
                ],
            ...
            [
                ...
                'actions' => [
                    ...
                    'print' => 'price_lists.print',
                    'export' => 'price_lists.export',
                    'review' => 'price_lists.review',
            ...
            [
                ...
                'children' => [
                    ...
                    $salesReport('sales_report_cost_of_sales', 'Cost of Sales', 'cost_of_sales', 'dollar-sign'),
                ],
            ],
        ],
    ],
