...
test('capitalized and disposed cards hide invalid master and movement actions', function (): void {
    ...
    $this->get(route('admin.fixed-assets.assets.edit', $asset))->assertStatus(409);
