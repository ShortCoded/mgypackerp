...
test('roles index requires view permission', function () {
    ...
    expect($dataTablesDefaultsScript)
        ->toContain('maxPageLength = 100')
        ->toContain('lengthMenuValues = [10, 25, 50, 75, maxPageLength]')
...
test('role form is reused as full pages for create edit and view modes', function () {
    ...
    $this->actingAs(userWithPermissions([
        ...
        ->assertSee('data-permission-node="human_resources_hr_employees"', false)
        ->assertSee('data-permission-nodes="human_resources human_resources_hr_employees"', false)
        ->assertSee('data-permission-node="human_resources_hr_employment_data"', false)
        ->assertSee('data-permission-node="human_resources_hr_employment_data_hr_departments"', false)
        ->assertSee('data-permission-nodes="human_resources human_resources_hr_employment_data human_resources_hr_employment_data_hr_departments"', false)
        ->assertDontSee('data-permission-node="human_resources_hr_countries"', false)
