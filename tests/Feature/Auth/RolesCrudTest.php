...
test('role form is reused as full pages for create edit and view modes', function () {
    ...
    $this->actingAs(userWithPermissions(['roles.create']))
        ...
        ->assertSee('data-permission-node="tools_file_manager"', false)
        ...
        ->assertSee('data-permission-node="human_resources_hr_departments"', false)
        ->assertSee('data-permission-nodes="human_resources human_resources_hr_departments"', false)
        ->assertDontSee('data-permission-node="human_resources_hr_basic_data"', false)
        ->assertDontSee('data-permission-node="human_resources_hr_basic_data_hr_countries"', false)
