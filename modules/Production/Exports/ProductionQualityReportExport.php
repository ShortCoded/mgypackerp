...
class ProductionQualityReportExport implements FromArray, ShouldAutoSize, WithHeadings, WithStrictNullComparison, WithTitle
{
    ...
    public function array(): array
    {
        return $this->inspections->map(fn ($inspection): array => [
            ...
            __('production_execution.quality_results.'.$inspection->result),
            $inspection->disposition ? __('production_execution.quality_dispositions.'.$inspection->disposition) : null,
            $inspection->affected_base_quantity,
            __('production_execution.statuses.'.$inspection->status),
