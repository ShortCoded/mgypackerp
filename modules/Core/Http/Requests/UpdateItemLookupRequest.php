...
class UpdateItemLookupRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        return (bool) $this->user()?->can($this->definition()->permission('edit'))
            && $this->record() instanceof ItemLookup;
    }
    ...
    public function withValidator(Validator $validator): void
    {
        ...
        $validator->after(function (Validator $validator): void {
            $this->validateEquivalentUnitIsNotSelf($validator, $this->record());
        });
    }
    ...
    private function record(): ?ItemLookup
    {
        $definition = $this->definition();
        $docNum = (string) $this->route('record');
        ...
        $record = $definition->modelClass::query()
