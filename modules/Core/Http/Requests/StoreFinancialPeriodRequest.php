...
class StoreFinancialPeriodRequest extends FormRequest
{
    public function authorize(): bool
    {
        if ($this->filled('clone_source_token')) {
            return (bool) $this->user()?->can('financial_periods.clone');
        }

        return (bool) $this->user()?->can('financial_periods.create');
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if ($fromDate !== null
                ...
                $this->addOverlapErrors($validator, $fromDate->toDateString(), $toDate->toDateString());
            }
    ...
    private function addOverlapErrors(Validator $validator, string $fromDate, string $toDate): void
    {
