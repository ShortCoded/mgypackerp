...
class StoreTaskBoardRequest extends FormRequest
{
    ...
    {
        return (bool) $this->user()?->can('task_boards.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'access_code' => [
                Rule::requiredIf(fn (): bool => $this->boolean('requires_password')),
                'nullable',
                'string',
                'max:100',
            ],
    ...
    protected function prepareForValidation(): void
    {
        ...
        foreach (['is_active', 'is_public', 'requires_password', 'clear_access_code'] as $field) {
