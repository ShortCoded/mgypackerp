...
class CompanyDocumentNumberSettingsService
{
    public const PrefixKey = 'document_numbers.companies.prefix';

    public const PaddingKey = 'document_numbers.companies.padding';
    ...
    public function current(): array
    {
        $values = $this->settings->many([
            ...
            self::PrefixKey => config('document_numbers.companies.prefix', ''),
            self::PaddingKey => config('document_numbers.companies.padding', 0),
