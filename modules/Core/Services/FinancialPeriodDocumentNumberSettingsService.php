...
class FinancialPeriodDocumentNumberSettingsService
{
    public const PrefixKey = 'document_numbers.financial_periods.prefix';

    public const PaddingKey = 'document_numbers.financial_periods.padding';
    ...
    public function current(): array
    {
        $values = $this->settings->many([
            ...
            self::PrefixKey => config('document_numbers.financial_periods.prefix', ''),
            self::PaddingKey => config('document_numbers.financial_periods.padding', 0),
        ]);
