...
class BranchDocumentNumberSettingsService
{
    public const PrefixKey = 'document_numbers.branches.prefix';

    public const PaddingKey = 'document_numbers.branches.padding';
    ...
    public function current(): array
    {
        $values = $this->settings->many([
            ...
            self::PrefixKey => config('document_numbers.branches.prefix', ''),
            self::PaddingKey => config('document_numbers.branches.padding', 0),
        ]);
