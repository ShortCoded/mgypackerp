...
class RoleDocumentNumberSettingsService
{
    public const PrefixKey = 'document_numbers.roles.prefix';

    public const PaddingKey = 'document_numbers.roles.padding';
    ...
    public function current(): array
    {
        $values = $this->settings->many([
            ...
            self::PrefixKey => config('document_numbers.roles.prefix', ''),
            self::PaddingKey => config('document_numbers.roles.padding', 0),
