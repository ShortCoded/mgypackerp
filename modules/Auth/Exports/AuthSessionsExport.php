...
class AuthSessionsExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping
{
    /**
    ...
    {
        return $this->report->query($this->filters)->latest('user_presence_sessions.login_at');
    }
