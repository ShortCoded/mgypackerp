...
class HrFoundationDocumentNumberSettingsService
{
     ...
     */
    public function current(HrFoundationDefinition $definition): array
    {
     ...
     */
    public function update(HrFoundationDefinition $definition, ?string $prefix, int $padding): array
    {
    ...
    private function prefixKey(HrFoundationDefinition $definition): string
    {
        return "document_numbers.{$definition->documentKey}.prefix";
    }

    private function paddingKey(HrFoundationDefinition $definition): string
    {
