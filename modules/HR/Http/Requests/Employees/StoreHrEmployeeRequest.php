...
class StoreHrEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'qualification_doc_num' => ['nullable', 'string', Rule::exists('hr_qualifications', 'doc_num')->whereNull('deleted_at')],
            'university_doc_num' => ['nullable', 'string', Rule::exists('hr_universities', 'doc_num')->whereNull('deleted_at')],
            'faculty_doc_num' => ['nullable', 'string', Rule::exists('hr_faculties', 'doc_num')->whereNull('deleted_at')],
            'specialization_doc_num' => ['nullable', 'string', Rule::exists('hr_specializations', 'doc_num')->whereNull('deleted_at')],
            'military_service_doc_num' => ['nullable', 'string', Rule::exists('hr_military_services', 'doc_num')->whereNull('deleted_at')],
            'graduation_year' => ['nullable', 'integer', 'min:1900', 'max:'.(now()->year + 10)],
