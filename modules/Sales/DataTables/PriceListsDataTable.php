...
class PriceListsDataTable
{
    ...
    public function json(Request $request): JsonResponse
    {
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('pricing_use', fn (PriceList $record): string => $this->plainText(__($record->is_print_only ? 'price_lists.print_only' : 'price_lists.operational')))
            ...
            ->orderColumn('pricing_use', 'price_lists.is_print_only $1')
