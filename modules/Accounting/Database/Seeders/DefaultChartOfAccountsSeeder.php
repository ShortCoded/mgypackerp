...
class DefaultChartOfAccountsSeeder extends Seeder
{
    ...
    private function accounts(): array
    {
        return [
            ...
            ['account_code' => '1131', 'name' => 'مخزون خامات', 'name_en' => 'Raw Materials Inventory', 'parent_code' => '113', 'classification_code' => 'raw_material_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '1132', 'name' => 'مخزون إنتاج تحت التشغيل', 'name_en' => 'Work in Process Inventory', 'parent_code' => '113', 'classification_code' => 'work_in_process_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '1133', 'name' => 'مخزون إنتاج تام', 'name_en' => 'Finished Goods Inventory', 'parent_code' => '113', 'classification_code' => 'finished_goods_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '1134', 'name' => 'مخزون مواد تعبئة وتغليف', 'name_en' => 'Packaging Materials Inventory', 'parent_code' => '113', 'classification_code' => 'packaging_material_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '1135', 'name' => 'مخزون منتجات نصف مصنعة', 'name_en' => 'Semi-finished Goods Inventory', 'parent_code' => '113', 'classification_code' => 'semi_finished_goods_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '1136', 'name' => 'مخزون تحت الفحص والحجر', 'name_en' => 'Quarantine Inventory', 'parent_code' => '113', 'classification_code' => 'quarantine_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '1137', 'name' => 'مخزون إعادة التشغيل', 'name_en' => 'Rework Inventory', 'parent_code' => '113', 'classification_code' => 'rework_inventory', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ...
            ['account_code' => '117', 'name' => 'ضريبة قيمة مضافة قابلة للاسترداد', 'name_en' => 'Recoverable Input VAT', 'parent_code' => '11', 'classification_code' => 'recoverable_vat', 'account_type' => Account::TypeAsset, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceDebit],
            ...
            ['account_code' => '212', 'name' => 'بضائع مستلمة غير مفوترة', 'name_en' => 'Goods Received Not Invoiced', 'parent_code' => '21', 'classification_code' => 'goods_received_not_invoiced', 'account_type' => Account::TypeLiability, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceCredit],
            ...
            ['account_code' => '2131', 'name' => 'ضريبة القيمة المضافة على المخرجات', 'name_en' => 'Output Value Added Tax', 'parent_code' => '213', 'classification_code' => 'output_vat_payable', 'account_type' => Account::TypeLiability, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceCredit],
            ['account_code' => '2132', 'name' => 'ضريبة الخصم والإضافة', 'name_en' => 'Withholding and Addition Tax', 'parent_code' => '213', 'classification_code' => 'withholding_tax_payable', 'account_type' => Account::TypeLiability, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceCredit],
            ['account_code' => '2133', 'name' => 'ضرائب أخرى', 'name_en' => 'Other Taxes', 'parent_code' => '213', 'classification_code' => 'other_current_liabilities', 'account_type' => Account::TypeLiability, 'statement_type' => Account::StatementFinancialPosition, 'normal_balance' => Account::BalanceCredit],
            ...
            ['account_code' => '432', 'name' => 'إيرادات متنوعة', 'name_en' => 'Miscellaneous Revenue', 'parent_code' => '43', 'classification_code' => 'gain_on_asset_disposal', 'account_type' => Account::TypeRevenue, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceCredit],
            ...
            ['account_code' => '512', 'name' => 'تكلفة الخدمات', 'name_en' => 'Cost of Services', 'parent_code' => '51', 'classification_code' => 'production_services_expense', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ...
            ['account_code' => '524', 'name' => 'الصيانة', 'name_en' => 'Maintenance', 'parent_code' => '52', 'classification_code' => 'factory_maintenance_expense', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ...
            ['account_code' => '526', 'name' => 'النقل والشحن', 'name_en' => 'Transportation and Freight', 'parent_code' => '52', 'classification_code' => 'freight_in', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ...
            ['account_code' => '551', 'name' => 'مصروفات متنوعة', 'name_en' => 'Miscellaneous Expenses', 'parent_code' => '55', 'classification_code' => 'loss_on_asset_disposal', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '552', 'name' => 'مشتريات أخرى', 'name_en' => 'Other Purchases', 'parent_code' => '55', 'classification_code' => 'other_purchases', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '553', 'name' => 'فروق أسعار الشراء', 'name_en' => 'Purchase Price Variance', 'parent_code' => '55', 'classification_code' => 'purchase_price_variance', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '554', 'name' => 'خسائر الهالك غير الطبيعي', 'name_en' => 'Abnormal Waste Loss', 'parent_code' => '55', 'classification_code' => 'abnormal_waste_loss', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '555', 'name' => 'خسائر تسويات المخزون', 'name_en' => 'Inventory Adjustment Loss', 'parent_code' => '55', 'classification_code' => 'inventory_adjustment_loss', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '556', 'name' => 'خسائر تلف وهالك المخازن', 'name_en' => 'Warehouse Damage and Scrap Loss', 'parent_code' => '55', 'classification_code' => 'warehouse_damage_loss', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '557', 'name' => 'مشتريات مواد خام غير مخزنة', 'name_en' => 'Non-inventory Raw Material Purchases', 'parent_code' => '55', 'classification_code' => 'raw_material_purchases', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '558', 'name' => 'مشتريات مستلزمات تشغيل غير مخزنة', 'name_en' => 'Non-inventory Operating Supplies Purchases', 'parent_code' => '55', 'classification_code' => 'operating_supplies_purchases', 'account_type' => Account::TypeExpense, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceDebit],
            ['account_code' => '433', 'name' => 'مكاسب تسويات المخزون', 'name_en' => 'Inventory Adjustment Gains', 'parent_code' => '43', 'classification_code' => 'inventory_adjustment_gain', 'account_type' => Account::TypeRevenue, 'statement_type' => Account::StatementIncomeStatement, 'normal_balance' => Account::BalanceCredit],
        ];
    }
}
