    ...
    ->group(function (): void {
        ...
        Route::middleware('erp.expanded')->controller(ProcurementWorkflowController::class)->group(function (): void {
            Route::prefix('purchase-requisitions')->name('purchase-requisitions.')->group(function (): void {
                ...
                Route::post('/', 'storeRequisition')->middleware('can:purchases.purchase_requisitions.create')->name('store');
                Route::get('/{purchaseRequisition}', 'showRequisition')->middleware('can:purchases.purchase_requisitions.view')->name('show');
                Route::post('/{purchaseRequisition}/submit', 'submitRequisition')->middleware('can:purchases.purchase_requisitions.edit')->name('submit');
            ...
            Route::prefix('request-for-quotations')->name('request-for-quotations.')->group(function (): void {
                ...
                Route::post('/from/{purchaseRequisition}', 'storeRfq')->middleware('can:purchases.request_for_quotations.create')->name('store');
            ...
            Route::prefix('supplier-quotation-entry')->name('supplier-quotation-entry.')->group(function (): void {
                ...
                Route::post('/from/{requestForQuotation}', 'storeQuotation')->middleware(['can:purchases.supplier_quotation_entry.create', 'can:purchases.prices.view'])->name('store');
            ...
            Route::prefix('supplier-selection')->name('supplier-selection.')->group(function (): void {
                ...
                Route::post('/from/{requestForQuotation}', 'storeSelection')->middleware(['can:purchases.supplier_selection.create', 'can:purchases.prices.view'])->name('store');
            ...
            Route::prefix('purchase-order-change-requests')->name('purchase-order-change-requests.')->group(function (): void {
                ...
                Route::post('/from/{purchaseOrder}', 'storeChangeRequest')->middleware(['can:purchases.purchase_order_change_requests.create', 'can:purchases.prices.view'])->name('store');
            ...
            Route::prefix('purchase-order-delivery-schedule')->name('purchase-order-delivery-schedule.')->group(function (): void {
                ...
                Route::post('/from/{purchaseOrder}', 'storeDeliverySchedule')->middleware('can:purchases.purchase_order_delivery_schedule.create')->name('store');
            });
            ...
            Route::prefix('goods-receipt-notes')->name('goods-receipt-notes.')->group(function (): void {
                ...
                Route::post('/from/{purchaseOrder}', 'storeReceipt')->middleware('can:purchases.goods_receipt_notes.create')->name('store');
            ...
            Route::prefix('goods-receipt-inspection')->name('goods-receipt-inspection.')->group(function (): void {
                ...
                Route::post('/from/{goodsReceiptNote}', 'storeInspection')->middleware('can:purchases.goods_receipt_inspection.create')->name('store');
            ...
            Route::prefix('purchase-returns')->name('purchase-returns.')->group(function (): void {
                ...
                Route::post('/', 'storeReturn')->middleware('can:purchases.purchase_returns.create')->name('store');
                Route::get('/{purchaseReturn}', 'showReturn')->middleware('can:purchases.purchase_returns.view')->name('show');
                Route::post('/{purchaseReturn}/approve', 'approveReturn')->middleware('can:purchases.purchase_returns.approve')->name('approve');
                Route::post('/{purchaseReturn}/reverse', 'reverseReturn')->middleware('can:purchases.purchase_returns.approve')->name('reverse');
            });
            ...
            Route::prefix('supplier-payments')->name('supplier-payments.')->middleware('can:purchases.prices.view')->group(function (): void {
                ...
                Route::post('/', 'storeSupplierPayment')->middleware('can:supplier_payments.create')->name('store');
