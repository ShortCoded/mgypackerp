    ...
    function initTable() {
        ...
        const table = $table.DataTable(options({
            ...
            columns: [
                ...
                { data: 'reorder_point', name: 'reorder_point', orderable: true, searchable: true, className: 'align-middle text-end white-space-nowrap', responsivePriority: 110 },
                ...
                { data: 'components_count', name: 'components_count', orderable: true, searchable: false, className: 'align-middle text-end white-space-nowrap', responsivePriority: 5 },
                ...
                { data: 'component_quantity', name: 'component_quantity', orderable: true, searchable: false, className: 'align-middle text-end white-space-nowrap', responsivePriority: 9 },
